""" Preguntas que el bot aprendera a identificar y entendera"""
store_examples = [
    ...
    "top 2000 mejores tiendas"

]
product_examples = [
    "¿Cuál es el mejor platillo?",
...
greeting_examples = [
    ...
    "¡Buen día!",
    "¡Hola, soy nuevo aquí!",
    "Hola, ¿tienes algo nuevo hoy?"
]

""" Preguntas mas especificas sobre el  topico de tiendas horarios, ranking y descripcion de la misma """
open_now_examples = [
