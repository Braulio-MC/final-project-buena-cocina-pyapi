...
BIGQUERY_SP_GET_TOP_RATED_STORES_NAME = "get_top_rated_stores"
REDIS_CACHE_PREFIX = "fastapi:bc:pyapi:cache"
INSIGHT_ROUTES_GET_TOP_LOCATIONS_ON_MAP_CACHE_EXPIRE = 60 * 60 * 3 # 3 hours
INSIGHT_ROUTES_CALCULATE_SALES_BY_DAY_OF_WEEK_CACHE_EXPIRE = 60 * 5 # 5 minutes
INSIGHT_ROUTES_GET_TOP_SOLD_PRODUCTS_CACHE_EXPIRE = 60 * 5 # 5 minutes
INSIGHT_ROUTES_GET_TOP_RATED_STORES_CACHE_EXPIRE = 60 * 5 # 5 minutes
